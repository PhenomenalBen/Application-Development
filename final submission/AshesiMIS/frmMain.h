...
private:
	...
	private:
		void AddLogoutButton() {
			...
			ToolStripMenuItem^ logoutItem = gcnew ToolStripMenuItem();
			logoutItem->Text = "Logout";
			logoutItem->BackColor = Drawing::Color::LightCoral;
			logoutItem->Click += gcnew EventHandler(this, &frmMain::logoutToolStripMenuItem_Click);
